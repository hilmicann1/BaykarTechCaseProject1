package WebAutomationBase.email;
...
public class EmailUtils {
    ...
    public String getAuthorizationCode() throws Exception {
        Message email = getMessagesBySubject("[GitHub] Please verify your device", true, 1)[0];
        ...
        Reader inputString = new StringReader(messageContent);
